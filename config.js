...
const CONFIG = {
  ...
  // ─── BUSINESS INFO ───────────────────────────────────────
  business: {
    name:      "MKWEPU ELECTRICAL (PTY)LTD",
    phone:     "+27 78 313 6248",
    whatsapp:  "+27 78 313 6248",
    address:   "17 Glenhove Rd, Johannesburg, South Africa",
  ...
  // ─── PAGE META / SEO ─────────────────────────────────────
  meta: {
    title:       "MKWEPU ELECTRICAL (PTY)LTD — Electrician in johannesburg",
    description: "MKWEPU ELECTRICAL (PTY)LTD provides professional electrician in Johannesburg. 3 Google reviews. Call for a quote today.",
  ...
  content: {
    ...
    heroLead:   "MKWEPU ELECTRICAL (PTY)LTD handles residential and commercial electrical work across Johannesburg. Fault-finding, DB board repairs, compliance certificates and new installations.",
    ...
    band: {
      ...
      alt:   "MKWEPU ELECTRICAL (PTY)LTD team at work in Johannesburg",
